    ...
    for project in projects:
        ...
        for pair in version_pairs:
            for dim in dimensions:
                ...
                promise_input = Input(shape=(18,), name='promise_input')
                promise_dense_out = Dense(128, name='promise_dense')(promise_input)
                promise_gate = Dense(128, activation='sigmoid', name='promise_gate')(promise_dense_out)
                promise_gated_res = Multiply(name='promise_gated_res')([promise_gate, promise_dense_out])
                ...
                early_stop = EarlyStopping(monitor='val_my_f1', patience=7, restore_best_weights=True, mode='max')
                ...
                np.save('./ghlstm_prediction_res/{}.npy'.format(task_name), predict_y)
